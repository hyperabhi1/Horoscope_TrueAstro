...
Public Class frmTransitChart
    ...
    Friend PlaceDataT As New NameValueCollection
    ...
    Private Sub frmTransitChart_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim TzDst As Double = PlaceDataT.Item("TzB") + PlaceDataT.Item("DstB")
        ...
        Horo.getBirthDasaFordateTime(DatetimeC, DateTimeB, PlaceDataT, DayDasa)
    ...
    Private Sub loadList()
        ...
        For i = 0 To 12
            ...
            Dim Retro As String = strP(10)
            Dim plRow1 As Object() = New Object() {pls, Sgn, DMS, SgnL, STL, SL, SSL, SukL, PraL, sPraL, IIf(Retro = "R", "Ret", "")}
    ...
    Private Sub btnCal1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCal1.Click
        ...
        Dim DayDasa As String = ""
        Horo.getBirthDasaFordateTime(DatetimeC, DateTimeB, PlaceDataT, DayDasa)
        lblToday.Text = DayDasa
        lbltithi.Text = Horo.getTithi(DatetimeC, PlaceDataT)
        Me.Cursor = Cursors.Default
        Me.Text = "Transit Chart for " & txtDay1.Text & "/" & txtMonth1.Text & "/" & txtYear1.Text & " :: " & txtHr1.Text & ":" & txtMin1.Text & ":" & txtSec1.Text
    End Sub
